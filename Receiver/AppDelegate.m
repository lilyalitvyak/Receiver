...
//  Receiver
//
//  Created by Vladimir Vaskin on 11.03.18.
//  Copyright © 2018 Studio Evolution. All rights reserved.
//
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Receiver"];
